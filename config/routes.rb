SampleApp::Application.routes.draw do
  ...
  match '/er', 		to:	'static_pages#er'
  match '/inclexcl',	to:	'static_pages#inclexcl'
  match '/trialelim',	to:	'static_pages#trialelim'
  match '/patientdata',	to:	'static_pages#patientdata'
  match '/datastack',	to:	'static_pages#datastack'


  match '/admin',	to:	'static_pages#admin'
  match '/tedit',	to:	'static_pages#tedit'
